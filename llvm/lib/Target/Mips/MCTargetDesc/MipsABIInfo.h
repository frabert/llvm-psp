...
class MipsABIInfo {
public:
  enum class ABI { Unknown, O32, N32, N64, Allegrex };
...
public:
  ...
  static MipsABIInfo Allegrex() { return MipsABIInfo(ABI::Allegrex); }
  ...
  bool IsAllegrex() const { return ThisABI == ABI::Allegrex; }
